...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/yaml-mode-20210808.1122/yaml-mode-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/yaml-mode-20210808.1122/yaml-mode-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/which-key-20210817.1735/which-key-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/which-key-20210817.1735/which-key-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/transient-20210819.2118/transient-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/transient-20210819.2118/transient-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/orderless-20210812.2035/orderless-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/orderless-20210812.2035/orderless-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/markdown-mode-20210819.57/markdown-mode-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/markdown-mode-20210819.57/markdown-mode-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/marginalia-20210821.1955/marginalia-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/marginalia-20210821.1955/marginalia-autoloads.el") (car load-path))))
...
(progn
  ...
  (setq Info-directory-list
        (append
         '("/home/scfrazer/.emacs.d/elpa/dash-20210708.2009" "/home/scfrazer/.emacs.d/elpa/orderless-20210812.2035" "/home/scfrazer/.emacs.d/elpa/rg-20210625.939" "/home/scfrazer/.emacs.d/elpa/transient-20210819.2118" "/home/scfrazer/.emacs.d/elpa/use-package-20210207.1926" "/home/scfrazer/.emacs.d/elpa/vertico-0.14" "/home/scfrazer/.emacs.d/elpa/with-editor-20210524.1654")
         Info-directory-list)))

;; Local Variables:
