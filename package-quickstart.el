...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/web-mode-20210131.1758/web-mode-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/web-mode-20210131.1758/web-mode-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/tron-legacy-theme-20210315.712/tron-legacy-theme-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/tron-legacy-theme-20210315.712/tron-legacy-theme-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/transient-20210315.1902/transient-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/transient-20210315.1902/transient-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/prescient-20210411.2007/prescient-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/prescient-20210411.2007/prescient-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/selectrum-20210417.2123/selectrum-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/selectrum-20210417.2123/selectrum-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/selectrum-prescient-20210411.2007/selectrum-prescient-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/selectrum-prescient-20210411.2007/selectrum-prescient-autoloads.el") (car load-path))))
...
(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/rg-20210305.1621/rg-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/realgud-20210417.1421/realgud-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/realgud-20210417.1421/realgud-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/popup-20210317.138/popup-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/popup-20210317.138/popup-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/orderless-20210407.1548/orderless-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/orderless-20210407.1548/orderless-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/markdown-mode-20210405.1349/markdown-mode-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/markdown-mode-20210405.1349/markdown-mode-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/marginalia-20210418.2159/marginalia-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/marginalia-20210418.2159/marginalia-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/jsonrpc-1.0.14/jsonrpc-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/jsonrpc-1.0.14/jsonrpc-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/eglot-20210413.21/eglot-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/eglot-20210413.21/eglot-autoloads.el") (car load-path))))
...
(setq package-activated-list
      (append
       '(yaml-mode xref xr with-editor which-key wgrep web-mode web-beautify visual-regexp bind-key use-package tron-legacy-theme transient test-simple tango-plus-theme sr-speedbar prescient selectrum selectrum-prescient rg relint reformatter load-relative loc-changes realgud python project popup orderless multiple-cursors monokai-pro-theme markdown-mode marginalia lv jsonrpc json-snatcher json-reformat json-mode iflipb hydra highlight-indent-guides goto-last-change git-timemachine eldoc flymake filladapt fill-function-arguments fd-dired eglot dash dired-hacks-utils dired-subtree diffview deft dash-functional browse-kill-ring bm beacon avy)
...
(progn
  ...
  (setq Info-directory-list
        (append
         '("/home/scfrazer/.emacs.d/elpa/dash-20210330.1544" "/home/scfrazer/.emacs.d/elpa/marginalia-20210418.2159" "/home/scfrazer/.emacs.d/elpa/orderless-20210407.1548" "/home/scfrazer/.emacs.d/elpa/rg-20210305.1621" "/home/scfrazer/.emacs.d/elpa/transient-20210315.1902" "/home/scfrazer/.emacs.d/elpa/use-package-20210207.1926" "/home/scfrazer/.emacs.d/elpa/with-editor-20210319.1930")
         Info-directory-list)))

;; Local Variables:
