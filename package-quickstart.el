...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/modus-vivendi-theme-20200824.752/modus-vivendi-theme-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/modus-vivendi-theme-20200824.752/modus-vivendi-theme-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/modus-operandi-theme-20200824.752/modus-operandi-theme-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/modus-operandi-theme-20200824.752/modus-operandi-theme-autoloads.el") (car load-path))))
...
(let ((load-file-name "/home/scfrazer/.emacs.d/elpa/markdown-mode-20200824.339/markdown-mode-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/home/scfrazer/.emacs.d/elpa/markdown-mode-20200824.339/markdown-mode-autoloads.el") (car load-path))))
...
(setq package-activated-list
      (append
       '(yaml-mode xr async with-editor wgrep web-mode web-beautify visual-regexp bind-key use-package undo-tree transient tommyh-theme tango-plus-theme sr-speedbar s rg relint popup orderless multiple-cursors modus-vivendi-theme modus-operandi-theme memoize markdown-mode lv json-snatcher json-reformat json-mode iflipb ido-vertical-mode ido-completing-read+ ido-at-point icomplete-vertical hydra htmlize highlight-indent-guides hc-zenburn-theme dash autothemer gruvbox-theme goto-chg git-timemachine fzf flymake-perlcritic flymake-eslint flymake-easy filladapt fill-function-arguments fd-dired expand-region dired-hacks-utils dired-subtree dired-narrow deft dash-functional crontab-mode browse-kill-ring bm avy auto-highlight-symbol)
