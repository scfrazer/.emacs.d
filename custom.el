...
(custom-set-variables
 ...
 '(package-selected-packages
   '(goto-last-change reformatter dired-narrow tango-plus-theme auto-highlight-symbol avy bm browse-kill-ring dash dash-functional deft dired-subtree fd-dired fill-function-arguments filladapt flymake-easy fzf git-timemachine highlight-indent-guides htmlize hydra icomplete-vertical ido-vertical-mode iflipb json-mode markdown-mode modus-operandi-theme modus-vivendi-theme multiple-cursors orderless popup relint rg sr-speedbar use-package visual-regexp web-beautify web-mode with-editor yaml-mode))
