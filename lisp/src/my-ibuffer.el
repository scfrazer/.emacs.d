...
(defun my-ibuffer-mode-hook ()
  ...
  (define-key ibuffer-mode-map (kbd "RET") (lambda (&optional arg) (interactive "P") (if (not arg) (ibuffer-visit-buffer-1-window) (setq prefix-arg nil) (ibuffer-visit-buffer))))
