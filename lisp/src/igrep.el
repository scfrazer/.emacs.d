...
(defun igrep-original-read-file-name (prompt directory default existing initial)
...
(defun igrep-read-file-name (prompt
  ...
  (if history
	...
	(prog1 (igrep-original-read-file-name prompt directory default existing initial)
	  (set history file-name-history)))
    (igrep-original-read-file-name prompt directory default existing initial)))

;; Menu bar:
