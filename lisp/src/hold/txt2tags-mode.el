...
;; data
(defface t2t-date-face '((t (:foreground "yellow" )))
  "Txt2Tags Date."  :group 'txt2tags-faces)

;; conf area
(defface t2t-config-face '((t (:foreground "yellow" )))
  "Txt2Tags Config Area."  :group 'txt2tags-faces)

;; conf area
(defface t2t-postproc-face '((t (:foreground "medium spring green" )))
  "Txt2Tags PostProc Area."  :group 'txt2tags-faces)

;; Verbatim
(defface t2t-verbatim-face '((t (:foreground "SpringGreen1" )))
  "Txt2Tags Verbatim."  :group 'txt2tags-faces)

;; http + e-mails

(defface t2t-internet-face '((t (:foreground "dark orchid" )))
  "Txt2Tags E-mail and Http." :group 'txt2tags-faces)

;; números

(defface t2t-numbers-face '((t (:foreground "plum1" )))
  "Txt2Tags Numbers." :group 'txt2tags-faces)

;; títulos de seções
(defface t2t-sections-face-5 '((t (:foreground "cyan" )))
  "Txt2Tags Section Titles." :group 'txt2tags-faces)

(defface t2t-sections-face-4 '((t (:foreground "cyan" )))
  "Txt2Tags Section Titles." :group 'txt2tags-faces)

(defface t2t-sections-face-3 '((t (:foreground "cyan" )))
  "Txt2Tags Section Titles." :group 'txt2tags-faces)

(defface t2t-sections-face-2 '((t (:foreground "cyan" )))
  "Txt2Tags Section Titles." :group 'txt2tags-faces)

(defface t2t-sections-face-1 '((t (:foreground "cyan" )))
  "Txt2Tags Section Titles." :group 'txt2tags-faces)

;; Comentários yellow4
(defface t2t-comments-face '((t (:foreground "yellow" )))
  "Txt2Tags Date." :group 'txt2tags-faces)

;; listas
(defface t2t-lists-face '((t (:foreground "dodger blue" )))
...
;; raw
(defface t2t-raw-face '((t (:foreground "spring green" )))
  "Txt2Tags Raw." :group 'txt2tags-faces)

;; region
(defface t2t-region-face '((t (:foreground "green" )))
  "Txt2Tags Region." :group 'txt2tags-faces)

;; imagens
(defface t2t-images-face '((t (:foreground "SlateBlue4" )))
  "Txt2Tags Images." :group 'txt2tags-faces)

;; negrito
(defface t2t-bold-face '((t (:width extra-expanded :weight extra-bold :foreground "midnight blue" )))
  "Txt2Tags Bold." :group 'txt2tags-faces)

;; itálico
(defface t2t-italic-face '((t (:slant italic :foreground "SlateBlue2" )))
  "Txt2Tags Italic." :group 'txt2tags-faces)

;; negrito + itálico
(defface t2t-bold-italic-face '((t (:width extra-expanded :weight extra-bold :slant italic
                                                                             :underline nil :foreground "medium slate blue" )))
  "Txt2Tags Bold Italic." :group 'txt2tags-faces)

;; tabelas
(defface t2t-tables-face '((t (:foreground "turquoise4"  :bold t)))
  "Txt2Tags Tables." :group 'txt2tags-faces)

;; sublinhado
(defface t2t-underline-face '((t (:underline t :foreground "SlateBlue2" )))
  "Txt2Tags Underline." :group 'txt2tags-faces)

;; linha
(defface t2t-line-face '((t (:bold t :foreground "Blue2" )))
  "Txt2Tags line face." :group 'txt2tags-faces)

;; Fonte para mostrar o final de linha em branco em vermelho

(defface t2t-trailing-whitespace '((t (:bold t :foreground "Red" )))
  "Txt2Tags line face." :group 'txt2tags-faces)
...
(defun t2t-insert-citation ()
  (interactive)
  (let ((citat (read-string "Texto: ")))
    (unless (equal citat "")
      (insert (format "\n\t %s" citat )))))

(defun t2t-insert-definition-list ()
  (interactive)
  (let ((descr (read-string "Item: ")))
    (unless (equal descr "")
      (insert (format "\n : %s \n" descr )))))

(defun t2t-insert-unumbered-list ()
  (interactive)
  (let ((unumberedlist (read-string "Item: ")))
    (unless (equal unumberedlist "")
      (insert (format "\n - %s" unumberedlist)))))

(defun t2t-insert-numbered-list ()
  (interactive)
  (let ((numberedlist (read-string "Item: ")))
...
(defun t2t-insert-link ()
  (interactive)
  (let ((linkname (read-string "Nome: ")) urllink)
...
(defun t2t-insert-image ()
  (interactive)
  (let ((fileplusextension (read-string "Arquivo.Ext: ")))
