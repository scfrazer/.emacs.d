...
(defvar django-html-open-block     "{%")
(defvar django-html-close-block    "%}")
(defvar django-html-open-comment   "{#")
(defvar django-html-close-comment  "#}")
(defvar django-html-open-variable  "{{")
(defvar django-html-close-variable "}}")

(defvar django-html-font-lock-keywords-1
  (append
   ;; html-mode keyword
...
(defvar django-html-font-lock-keywords-2
  (append
   django-html-font-lock-keywords-1
   sgml-font-lock-keywords-2))

(defvar django-html-font-lock-keywords-3
  (append
   django-html-font-lock-keywords-1
