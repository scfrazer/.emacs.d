...
(defun white ()
  ...
  (let ((class '((class color) (min-colors 89))))
    (custom-theme-set-faces
     ...
     `(isearch ((,class (:foreground "#ffffff"))))
     `(isearch-fail ((,class (:foreground "#ffffff"))))
     `(isearch-lazy-highlight-face ((,class (:foreground "#ffffff"))))
     ...
     `(show-paren-match-face ((,class (:foreground "#ffffff"))))
     `(show-paren-match-face ((,class (:foreground "#ffffff"))))
