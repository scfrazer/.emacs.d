...
(defvar lorem-ipsum-paragraph-separator "<br/>\n")
(defvar lorem-ipsum-sentence-separator " ")
(defvar lorem-ipsum-list-beginning "<ul>\n")
(defvar lorem-ipsum-list-bullet "<li>")
(defvar lorem-ipsum-list-item-end "</li>\n")
(defvar lorem-ipsum-list-end "</ul>\n")
...
If NUM is non-nil, insert NUM paragraphs."
  (interactive "P")
  (setq num (or num (length lorem-ipsum-text)))
  (if (> num 0)
      (progn
        (insert (concat
                 (mapconcat 'identity
