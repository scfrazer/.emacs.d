...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(ediff-current-diff-A ((,class (:background "#D7AF5F" :foreground "black"))))
   `(ediff-current-diff-B ((,class (:background "#AFD7D7" :foreground "black"))))
   `(ediff-even-diff-A ((,class (:background "#E4E4E4" :foreground "Black"))))
   `(ediff-even-diff-B ((,class (:background "#E4E4E4" :foreground "black"))))
   `(ediff-fine-diff-A ((,class (:background "#FFD75F"))))
   `(ediff-fine-diff-B ((,class (:background "#5FD7FF"))))
   `(ediff-odd-diff-A ((,class (:background "#C6C6C6" :foreground "black"))))
   `(ediff-odd-diff-B ((,class (:background "#C6C6C6" :foreground "Black"))))
   ...
   `(highlight ((,class (:background "#87D7FF" :foreground "black"))))
   `(hl-line ((,class (:inherit nil :background "#FFFFD7"))))
   `(ido-first-match ((,class (:weight normal :foreground "black" :background "#AFFFFF"))))
   `(ido-only-match ((,class (:weight normal :foreground "black" :background "#87FF87"))))
   ...
   `(my-debug-face ((,class (:background "#FF8700" :foreground "black"))))
   `(my-fixme-face ((,class (:background "red" :foreground "#FFFFFF"))))
   `(my-modified-face ((,class (:background "#AF0000" :foreground "#E4E4E4"))))
   `(my-narrow-face ((,class (:background "brightyellow" :foreground "black"))))
   `(my-read-only-face ((,class (:background "#FF8700" :foreground "black"))))
   ...
   `(show-paren-mismatch-face ((,class (:background "brightred" :foreground "#FFFFFF"))))
