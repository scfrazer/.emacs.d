...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(font-lock-string-face ((,class (:foreground "#AF0087"))))
   ...
   `(ido-first-match ((,class (:weight normal :foreground "#000000" :background "#AFD7AF"))))
   `(ido-only-match ((,class (:weight normal :foreground "#000000" :background "#AFFFAF"))))
