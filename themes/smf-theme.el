...
(let ((dark '((class color) (background dark)))
  ...
  (custom-theme-set-faces
   ...
   `(isearch                             ((,dark :foreground ,(smf-color 231) :background ,(smf-color 203)) (,light :background "magenta" :foreground ,(smf-color 231))))
   ...
   `(lazy-highlight                      ((,dark :foreground ,(smf-color 231) :background ,(smf-color 66)) (,light :background "color-225" :foreground "black")))
   ...
   `(linum                               ((,dark :foreground ,(smf-color 143) :background "black" :slant italic) (,light :foreground ,(smf-color 104) :background ,(smf-color 255) :slant italic)))
