...
(let ((dark '((class color) (background dark)))
  ...
  (custom-theme-set-faces
   ...
   `(avy-lead-face                    ((,dark :foreground "white" :background "color-161" :slant normal :weight bold) (,light :foreground "color-161" :background "color-255" :slant normal :weight bold)))
   ...
   `(error                            ((,dark :inherit font-lock-warning-face)))
   `(font-lock-builtin-face           ((,dark :foreground "color-44")))
   `(font-lock-comment-delimiter-face ((,dark :inherit font-lock-comment-face)))
   `(font-lock-comment-face           ((,dark :foreground "color-102" :slant italic) (,light :foreground "color-60" :slant italic)))
   `(font-lock-constant-face          ((,dark :foreground "color-72")))
   `(font-lock-doc-face               ((,dark :foreground "color-137")))
   `(font-lock-doc-string-face        ((,dark :inherit font-lock-doc-face)))
   ...
   `(font-lock-warning-face           ((,dark :foreground "color-203" :weight bold)))
   `(header-line                      ((,dark :foreground "color-236" :background "white")))
   `(highlight                        ((,dark :foreground "color-254" :background "color-66")))
   `(ido-first-match                  ((,dark :foreground "color-227" :background nil)))
   `(ido-only-match                   ((,dark :foreground "color-41" :background nil)))
   `(ido-subdir                       ((,dark :inherit font-lock-keyword-face)))
   `(isearch                          ((,dark :foreground "black" :background "color-229")))
   `(js2-function-param               ((,dark :inherit font-lock-variable-name-face)))
   `(lazy-highlight                   ((,dark :background "color-66")))
   `(link                             ((,dark :foreground "color-81" :underline t)))
   `(link-visited                     ((,dark :foreground "color-212" :underline t)))
   `(minibuffer-prompt                ((,dark :foreground "color-74")))
   ...
   `(region                           ((,dark :foreground "color-254" :background "color-23")))
   `(show-mark-face                   ((,dark :foreground nil :background "color-58")))
   `(show-paren-match-face            ((,dark :foreground "color-46" :background "color-238" :weight bold)))
   `(show-paren-mismatch-face         ((,dark :foreground "color-160" :background "color-238" :weight bold)))
   `(trailing-whitespace              ((,dark :background "color-24")))

;;    `(bm-face                                 ((,dark (:foreground nil :background "color-227"))))
...
;;    `(header-line                             ((,dark (:foreground "color-254" :background "color-236" :underline nil))))
...
;;    `(highlight                               ((,dark (:foreground "black" :background "color-117"))))
...
;;    `(isearch                                 ((,dark (:foreground "color-15" :background "color-202"))))
...
;;    `(lazy-highlight-face                     ((,dark (:foreground "black" :background "color-181"))))
;;    `(link                                    ((,dark (:foreground "color-20"))))
;;    `(link-visited                            ((,dark (:foreground "color-13" :inherit link))))
...
;;    `(minibuffer-prompt                       ((,dark (:foreground "color-24"))))
;;    `(mode-line                               ((,dark (:foreground "black" :background "color-250"))))
;;    `(mode-line-buffer-id                     ((,dark (:foreground "color-20"))))
;;    `(mode-line-inactive                      ((,dark (:foreground "color-250" :background "color-255"))))
...
;;    `(my-tab-face                             ((,dark (:background "color-224"))))
...
;;    `(region                                  ((,dark (:background "color-153"))))
...
;;    `(warning                                 ((,dark (:foreground "color-100" :weight bold))))
