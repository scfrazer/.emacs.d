...
(let ((dark '((class color) (background dark)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line                           ((,dark :foreground ,(smf-color 231) :background ,(smf-color 24)) (,light :background ,(smf-color 250) :foreground "black")))
   `(mode-line-buffer-id                 ((,dark :foreground ,(smf-color 220)) (,light :foreground ,(smf-color 20))))
   `(mode-line-inactive                  ((,dark :foreground ,(smf-color 231) :background ,(smf-color 102)) (,light :background ,(smf-color 255) :foreground ,(smf-color 250))))
