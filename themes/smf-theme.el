...
(let ((dark '((class color) (background dark)))
  ...
  (custom-theme-set-faces
   ...
   `(diff-added                              ((,dark :background ,(smf-color 22))))
   `(diff-removed                            ((,dark :background ,(smf-color 52))))
   ...
   `(hl-line                                 ((,dark :background ,(smf-color 234) :inherit nil) (,light :background ,(smf-color 255) :inherit nil)))
   ...
   `(show-mark-face                          ((,dark :foreground nil :background ,(smf-color 238))))
   ...
   `(trailing-whitespace                     ((,dark :background ,(smf-color 67)) (,light :background ,(smf-color 195))))
   ...
   `(whitespace-tab                          ((,dark :background ,(smf-color 95)) (,light :background ,(smf-color 224))))
