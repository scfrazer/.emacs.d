...
(let ((dark '((class color) (background dark)))
  ...
  (custom-theme-set-faces
   ...
   `(diff-added                          ((t :foreground "color-46")))
   `(diff-changed                        ((t :inherit font-lock-keyword-face)))
   `(diff-refine-added                   ((t :inherit success)))
   `(diff-refine-change                  ((t :background "color-18" :foreground "color-153")))
   `(diff-refine-removed                 ((t :inherit error)))
   `(diff-removed                        ((t :foreground "color-196")))
