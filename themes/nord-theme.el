...
(defun nord-graphic-p () t)

(let ((class '((class color) (min-colors 89)))
  (nord0 (if (nord-graphic-p) "#2E3440" nil))
  (nord1 (if (nord-graphic-p) "#3B4252" "black"))
  (nord2 (if (nord-graphic-p) "#434C5E" "#434C5E"))
  (nord3 (if (nord-graphic-p) "#4C566A" "brightblack"))
  (nord4 (if (nord-graphic-p) "#D8DEE9" "#D8DEE9"))
  (nord5 (if (nord-graphic-p) "#E5E9F0" "white"))
  (nord6 (if (nord-graphic-p) "#ECEFF4" "brightwhite"))
  (nord7 (if (nord-graphic-p) "#8FBCBB" "cyan"))
  (nord8 (if (nord-graphic-p) "#88C0D0" "brightcyan"))
  (nord9 (if (nord-graphic-p) "#81A1C1" "blue"))
  (nord10 (if (nord-graphic-p) "#5E81AC" "brightblue"))
  (nord11 (if (nord-graphic-p) "#BF616A" "red"))
  (nord12 (if (nord-graphic-p) "#D08770" "brightyellow"))
  (nord13 (if (nord-graphic-p) "#EBCB8B" "yellow"))
  (nord14 (if (nord-graphic-p) "#A3BE8C" "green"))
  (nord15 (if (nord-graphic-p) "#B48EAD" "magenta"))
  (nord-annotation (if (nord-graphic-p) "#D08770" "brightyellow"))
  (nord-attribute (if (nord-graphic-p) "#8FBCBB" "cyan"))
  (nord-class (if (nord-graphic-p) "#8FBCBB" "cyan"))
  (nord-comment (if (nord-graphic-p) (nord-theme--brightened-comment-color nord-comment-brightness) "brightblack"))
  (nord-escape (if (nord-graphic-p) "#D08770" "brightyellow"))
  (nord-method (if (nord-graphic-p) "#88C0D0" "brightcyan"))
  (nord-keyword (if (nord-graphic-p) "#81A1C1" "blue"))
  (nord-numeric (if (nord-graphic-p) "#B48EAD" "magenta"))
  (nord-operator (if (nord-graphic-p) "#81A1C1" "blue"))
  (nord-preprocessor (if (nord-graphic-p) "#5E81AC" "brightblue"))
  (nord-punctuation (if (nord-graphic-p) "#D8DEE9" "#D8DEE9"))
  (nord-regexp (if (nord-graphic-p) "#EBCB8B" "yellow"))
  (nord-string (if (nord-graphic-p) "#A3BE8C" "green"))
  (nord-tag (if (nord-graphic-p) "#81A1C1" "blue"))
  (nord-variable (if (nord-graphic-p) "#D8DEE9" "#D8DEE9"))
...
;;;; +------------+
  (custom-theme-set-faces
    ...
    `(trailing-whitespace ((,class (:background "#405870"))))
    ...
    `(whitespace-tab ((,class (:foreground "black" :background ,nord15))))
