...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(isearch ((,class (:background "color-202" :foreground "#FFFFFF"))))
   `(isearch-fail ((,class (:background "#CD0000" :foreground "#FFFFFF"))))
   `(isearch-lazy-highlight-face ((,class (:background "color-181" :foreground "#000000"))))
   `(lazy-highlight-face ((,class (:background "color-181" :foreground "#000000"))))
