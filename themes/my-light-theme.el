...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(ace-jump-face-foreground ((,class (:foreground "red" :background "#DADADA"))))
   ...
   `(mode-line ((,class (:background "#D0D0D0" :foreground "black"))))
   `(mode-line-buffer-id ((,class (:foreground "#0000D7"))))
   `(mode-line-inactive ((,class (:background "#949494" :foreground "#444444"))))
   ...
   `(show-paren-mismatch-face ((,class (:background "red" :foreground "#FFFFFF"))))
