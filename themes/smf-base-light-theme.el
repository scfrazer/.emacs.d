...
(custom-theme-set-faces
 ...
 `(info-header-xref                    ((t :foreground "skyblue2" :italic nil)))
 `(isearch                             ((t :background "coral2" :foreground ,(smf-color 231))))
 `(lazy-highlight                      ((t :background "lightsteelblue" :foreground "black")))
 `(line-number                         ((t :foreground "#c0c0c0" :background "#f0f0f0" :italic nil :underline nil)))
 `(line-number-current-line            ((t :inherit line-number :foreground "#000000" :inverse-video nil :underline nil)))
 `(link                                ((t :foreground ,(smf-color 26) :italic nil :underline t)))
 `(link-visited                        ((t :foreground ,(smf-color 93) :italic nil :underline t)))
 ...
 `(vertico-current                     ((t :background "#ddeeff")))
