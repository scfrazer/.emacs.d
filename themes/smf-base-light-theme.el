...
(custom-theme-set-faces
 'smf-base-light
   ...
   `(link                           ((t :foreground ,(smf-color 26) :slant italic :underline t)))
   `(link-visited                   ((t :foreground ,(smf-color 93) :slant italic :underline t)))
   `(linum                          ((t :foreground ,(smf-color 60) :background ,(smf-color 255) :slant italic)))
