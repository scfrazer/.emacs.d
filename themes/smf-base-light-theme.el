...
(custom-theme-set-faces
 ...
 `(dired-subtree-depth-1-face     ((t :background "gray97")))
 `(dired-subtree-depth-2-face     ((t :background "gray94")))
 `(dired-subtree-depth-3-face     ((t :background "gray91")))
 `(dired-subtree-depth-4-face     ((t :background "gray88")))
 `(dired-subtree-depth-5-face     ((t :background "gray85")))
 `(dired-subtree-depth-6-face     ((t :background "gray82")))
