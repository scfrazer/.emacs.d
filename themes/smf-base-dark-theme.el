...
(custom-theme-set-faces
 'smf-base-dark
   ...
   `(bm-face                        ((t :background ,(smf-color 238))))
   ...
   `(link                           ((t :foreground ,(smf-color 81) :slant italic :underline t)))
   `(link-visited                   ((t :foreground ,(smf-color 212) :slant italic :underline t)))
   `(linum                          ((t :foreground ,(smf-color 143) :background "black" :slant italic)))
