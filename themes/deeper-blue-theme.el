...
(deftheme deeper-blue
  "Theme with a deep blue backgound.")
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(ediff-current-diff-A ((,class (:background "darkslategray" :foreground "white"))))
   `(ediff-current-diff-B ((,class (:background "darkslategray" :foreground "white"))))
   `(ediff-fine-diff-A ((,class (:background "dodgerblue4" :foreground "white"))))
   `(ediff-fine-diff-B ((,class (:background "dodgerblue4" :foreground "white"))))
